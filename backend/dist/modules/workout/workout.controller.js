...
let WorkoutController = class WorkoutController {
    constructor(workoutService, recommendationService) {
    ...
    filter(type, difficulty, duration) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], WorkoutController.prototype, "getRecommendations", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], WorkoutController.prototype, "filter", null);
